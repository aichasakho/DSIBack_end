    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('valideVisite.demande')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row g-3 align-items-center">
              ...
              <input type="hidden" name="id" value="<?php echo e($visite->id); ?>">
            </div>
...
<?php /**PATH C:\Users\sakho\DSIBack_end\resources\views/admin/visite/valide.blade.php ENDPATH**/ ?>