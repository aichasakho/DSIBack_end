                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form action="<?php echo e(route('store.immeuble')); ?>" method="POST"
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input type="file" name="image" class="form-control" id="image"
                                                  value="<?php echo e(old('image')); ?>" placeholder="image">
                                        </div>

                                        <div class="my-3">
                                            <label for="prix" class="form-label">Prix</label>
                                            <input type="number" name="prix" class="form-control"
                                                   value="<?php echo e(old('prix')); ?>" id="prix" placeholder="100000">
                                        </div>
...
<?php /**PATH C:\Users\Claude\Desktop\Folders\Aicha_DSI\DSIBack_end\resources\views/admin/immeuble/add.blade.php ENDPATH**/ ?>