                  ...
                  <div class="table-responsive">
                    <form action="<?php echo e(route('update.terrain', $terrain)); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="my-3">
                        ...
                        <input type="number" name="superficie" class="form-control" id="nom"
                          value="<?php echo e(old('superficie', $terrain->superficie)); ?>" placeholder="superficie">
                      </div>

                      <div class="my-3">
                        <label for="prix" class="form-label">Prix</label>
                        <input type="number" name="prix" class="form-control" value="<?php echo e(old('prix', $terrain->prix)); ?>"
                      ...
                      <div class="my-3">
                        ...
                        <select class="form-select" name="proprietaire_id" id="proprietaire"
                          ...
                          <option value="<?php echo e($terrain->proprietaire_id); ?>" selected>
                            <?php echo e($terrain->proprietaire->nom); ?> <?php echo e($terrain->proprietaire->prenoms); ?>
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" name="localite_id" id="localite"
                          ...
                          <option value="<?php echo e($terrain->localite_id); ?>" selected>
                            <?php echo e($terrain->localite->ville); ?> <?php echo e($terrain->localite->quartier); ?>
...
</html><?php /**PATH C:\Users\Claude\Desktop\Folders\Aicha_DSI\DSIBack_end\resources\views/admin/terrain/edit.blade.php ENDPATH**/ ?>