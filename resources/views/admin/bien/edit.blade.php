            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="titre" value="{{$bien->titre}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Superficie</label>
                  <input type="text" name="superficie" value="{{$bien->superficie}}" class="form-control" id="exampleInputPassword1">
                </div>

                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Prix-location</label>
                    <input type="number" name="prix_location" value="{{$bien->prix_location}}" class="form-control" id="exampleInputPassword1">
                  </div>

                  <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Status</label>
                      <select name="status" id="">
                        <option value="{{$bien->status}}">{{$bien->status ?'Disponible' :'Non-Disponible'}}</option>
                  ...
                  <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Proprietaire</label>
                      ...
                      <option value="{{$bien->proprietaire_id}}">{{$bien->proprietaire->nom}}</option>
