                    ...
                    <form action="{{ route('update.terrain', $terrain) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="my-3">
                        ...
                        <input type="number" name="superficie" class="form-control" id="nom"
                          value="{{ old('superficie', $terrain->superficie) }}" placeholder="superficie">
                      </div>

                      <div class="my-3">
                        <label for="prix" class="form-label">Prix</label>
                        <input type="number" name="prix" class="form-control" value="{{ old('prix', $terrain->prix) }}"
                      ...
                      <div class="my-3">
                        ...
                        <select class="form-select" name="proprietaire_id" id="proprietaire"
                          ...
                          <option value="{{ $terrain->proprietaire_id }}" selected>
                            {{ $terrain->proprietaire->nom }} {{ $terrain->proprietaire->prenoms }}
                          </option>
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" name="localite_id" id="localite"
                          ...
                          <option value="{{ $terrain->localite_id }}" selected>
                            {{ $terrain->localite->ville }} {{ $terrain->localite->quartier }}
                          </option>
